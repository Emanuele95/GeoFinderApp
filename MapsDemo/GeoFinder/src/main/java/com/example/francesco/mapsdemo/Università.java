...
public class Università extends AsyncTask<Object,String,String> {
    ...
    protected String doInBackground(Object... objects) {
        ...
        json_url = "http://aeff.hopto.org:8002/Test/fetch_università.php?email="+email;
    ...
    protected void onPostExecute(String s) {
        ...
        try {
            ...
            for (int i = 0; i < array.length(); i++ ) {
                ...
                int idUser = (int)jsonObject.get("idUser");
