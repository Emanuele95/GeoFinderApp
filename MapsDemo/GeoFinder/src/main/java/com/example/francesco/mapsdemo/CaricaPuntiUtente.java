...
public class CaricaPuntiUtente extends AsyncTask<Object,String,String> {
    ...
    public String doInBackground(Object... objects) {
        ...
        punti_url = "http://aeff.hopto.org:8002/Test/caricaPunti.php?email="+email;
        mMap = (GoogleMap) objects[0];

            try {
            URL url = new URL(punti_url);
